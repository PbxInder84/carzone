      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <section className="py-12">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-800">The Experts Behind CarZone</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Meet the passionate professionals who make CarZone your trusted destination for automotive excellence.
            </p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {teamData.map((member, index) => (
              <div key={index} className="backdrop-blur-sm bg-white/80 rounded-xl shadow-lg border border-gray-100 p-6 text-center transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                <img
                  loading="lazy"
                  src={member.image}
