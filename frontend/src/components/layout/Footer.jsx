        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex space-x-3">
              <a href={contact?.socialMedia?.facebook || '#'} className="h-8 w-8 rounded-full bg-primary-700 hover:bg-primary-600 flex items-center justify-center transition duration-300">
                <FaFacebookF className="text-white text-sm" />
              </a>
              <a href={contact?.socialMedia?.twitter || '#'} className="h-8 w-8 rounded-full bg-primary-700 hover:bg-primary-600 flex items-center justify-center transition duration-300">
                <FaTwitter className="text-white text-sm" />
              </a>
              <a href={contact?.socialMedia?.instagram || '#'} className="h-8 w-8 rounded-full bg-primary-700 hover:bg-primary-600 flex items-center justify-center transition duration-300">
                <FaInstagram className="text-white text-sm" />
              </a>
              <a href="https://github.com/" className="h-8 w-8 rounded-full bg-primary-700 hover:bg-primary-600 flex items-center justify-center transition duration-300">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/terms-conditions" className="text-gray-300 hover:text-white transition duration-300">
                  Terms & Conditions
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/sitemap" className="text-gray-300 hover:text-white transition duration-300">
                  Sitemap
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">{contact?.address || 'Rajpura, Panjab, India - 140401'}</span>
              </li>
              <li className="flex items-center">
                <FaPhone className="text-gray-400 mr-3" />
                <span className="text-gray-300">{contact?.phone || '+1-555-123-4567'}</span>
              </li>
              <li className="flex items-center">
                <FaEnvelope className="text-gray-400 mr-3" />
                <span className="text-gray-300">{contact?.email || 'support@carzone.com'}</span>
              </li>
            </ul>
          </div>
        </div>
